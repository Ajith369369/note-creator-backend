...
dotenv_1.default.config(); // loads env variable
// import express
...
// create server
const noteCreatorServer = (0, express_1.default)();
// connect server with frontend
noteCreatorServer.use((0, cors_1.default)());
// parse json format of data received at the server side - json()
noteCreatorServer.use(express_1.default.json());
// Not used in this project
// Application-specific Middleware
// noteCreatorServer.use(appmiddleware);
// router
noteCreatorServer.use(router_1.default);
...
noteCreatorServer.use("/uploads", express_1.default.static(path_1.default.join(__dirname, "uploads")));
